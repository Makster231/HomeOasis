(function ($, window, document) {
  function navigation() {
    $(".js_nav-item").click(function () {
      ...
      $(".js_section, .js_footer-services, .js_footer-awards").addClass(
        "js_hidden"
      );
      ...
      $(".js_footer-navigation").removeClass(
        "js_navigation-portfolio  js_navigation-services js_navigation-blog js_navigation-contacts js_navigation-awards"
      );
      ...
      if ($this.is(".js_nav-portfolio")) {
        ...
        $(".js_section-portfolio, .js_footer-navigation").removeClass(
          "js_hidden"
        );
      ...
      if ($this.is(".js_nav-awards")) {
        ...
        $(
          ".js_section-awards, .js_footer-awards, .js_awards-diploma, js_footer-navigation"
        ).removeClass("js_hidden");
        // Показываем стрелки / добавляем класс пункту меню / добавляем класс навигации навигации diploma
        $(
          ".js_footer-navigation, .js_nav-awards, .js_awards-diploma--item"
        ).addClass("js_active");
        ...
        $(
          ".js_footer-description, .js_awards-thanks, .js_section-awards--form"
        ).addClass("js_hidden");
      ...
      if ($this.is(".js_nav-services")) {
        ...
        $(
          ".js_section-services, .js_footer-services, .js_services-design, js_footer-navigation"
        ).removeClass("js_hidden");
        // Показываем стрелки / добавляем класс пункту меню / добавляем класс навигации навигации design
        $(
          ".js_footer-navigation, .js_nav-services, .js_services-design--item"
        ).addClass("js_active");
        ...
        $(
          ".js_footer-description, .js_services-beautification, .js_section-services--form"
        ).addClass("js_hidden");
        // добавляем стрелкам метку для слайдера
      ...
      if ($this.is(".js_nav-contacts")) {
        ...
        $(".js_section-contacts, .js_footer-navigation").removeClass(
          "js_hidden"
        );
        // Показываем стрелки, добавляем класс пункту меню
